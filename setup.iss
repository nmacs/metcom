...
[Files]
Source: "package\TGlobal.exe";             DestDir: "{app}"; Flags: ignoreversion
...
Filename: "{tmp}\vc_redist.x86.exe"; Parameters: "/passive /Q:a /c:""msiexec /qb /i vcredist.msi"" "; StatusMsg: Installing Visual Studio 2012 RunTime...; Check: VCRedistNeedsInstall
